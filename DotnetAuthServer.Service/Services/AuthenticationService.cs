...
namespace DotnetAuthServer.Service.Services
{
    public class AuthenticationService : IAuthenticationService
    {
        ...
        {
            if (loginDto == null) throw new ArgumentNullException(nameof(loginDto)); //bos ise loginDto hakkinda hata firlat. 
            ...
            var userRefreshToken = await _userRefreshTokenService.Where(x => x.UserId == user.Id).SingleOrDefaultAsync(); // get userRefreshToken to database

            if (userRefreshToken == null) // refresh token not coming to database.
            {
